...
final class Version20210411174049 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE purchase (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, purchased_by_id INT NOT NULL, status INT NOT NULL, coins_earned INT NOT NULL, payment_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_6117D13B4584665A (product_id), INDEX IDX_6117D13B51D43F65 (purchased_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purchase DROP FOREIGN KEY FK_6117D13B51D43F65');
